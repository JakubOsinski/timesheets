...
namespace RebootIT.TimesheetApp.Controllers
{
    public class TimesheetsController : Controller
    {
        ...
        // GET: Timesheets
        public async Task<IActionResult> Index(int? staffId, int? clientId, int? locationId)
        {
            var timesheetDbContext = _context.Timesheets
              ...
              .Where(t => !clientId.HasValue || t.ClientId == clientId)
             .Where(t => !locationId.HasValue || t.LocationId == locationId);
